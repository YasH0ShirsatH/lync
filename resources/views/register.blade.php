                                    ...
                                    <div class="row gy-3 overflow-hidden">
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating mb-3">
                                                <input type=text class="form-control @error('user') is-invalid @enderror " name="user" id="user" value="{{old('user')}}"  placeholder="username" >
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating mb-3">
                                                <input type="password" class="form-control @error('password') is-invalid @enderror " name="password_confirmation" id="confirm_password" value="" placeholder="Confirm Password" >
